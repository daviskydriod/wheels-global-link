...
export const vehicles: Vehicle[] = [
 ...
 {slug:"mercedes-benz-e-class",brand:"Mercedes-Benz",model:"E-Class",year:2023,condition:"Pre-owned",fuel:"Petrol",transmission:"Automatic",price:"Contact for Price",mileage:"On request",engine:"2.0L Turbo",color:"Obsidian Black",availability:"Subject to confirmation",image:mercedes,description:"An executive sedan with premium appointments, composed road manners and a sophisticated cabin."},
 {slug:"bmw-5-series",brand:"BMW",model:"5 Series",year:2023,condition:"Pre-owned",fuel:"Petrol",transmission:"Automatic",price:"Contact for Price",mileage:"On request",engine:"2.0L Turbo",color:"Metallic Blue",availability:"Subject to confirmation",image:bmw,description:"A dynamic executive sedan balancing performance, comfort and contemporary driver technology."},
 {slug:"range-rover-sport",brand:"Range Rover",model:"Sport",year:2022,condition:"Pre-owned",fuel:"Petrol",transmission:"Automatic",price:"Contact for Price",mileage:"On request",engine:"3.0L",color:"Graphite",availability:"Available to source",image:rangeRover,description:"A premium performance SUV with commanding presence, refined comfort and all-road capability."},
 {slug:"hyundai-santa-fe",brand:"Hyundai",model:"Santa Fe",year:2024,condition:"New",fuel:"Petrol",transmission:"Automatic",price:"Contact for Price",mileage:"Delivery mileage",engine:"2.5L",color:"Silver",availability:"Available to source",image:hyundai,description:"A practical modern SUV with generous interior space and family-focused comfort."},
];
